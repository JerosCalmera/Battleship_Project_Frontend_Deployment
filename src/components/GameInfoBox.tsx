                ...
                <div className="gameInfoOuter">
                    <div className="gameInfo">
                        ...
                        <div className="centre">
                            {shipInfo.length === 60 && readyStatus === "Not Ready" ? <><br /> <br /> <button onClick={handleConfirmReady} className="button">Ready</button></> : null}
                            {shipInfo.length > 1 && shipInfo.length < 60 ? <h4>Placing ships...</h4> : null}
                            {shipInfo.length < 1 && readyStatus === "Not Ready" ? <><br /> <br /> <button onClick={randomPlacement} className="button">Random Ship Placement</button></> : null}
                        </div>
